...
int Welcome()
{
	loadimage( NULL, _T("./res/Images/w1.jpg"), 500, 450 );
	int player_number = 1;
...
int Chose_role()
{
	...
	IMAGE bg_img;
	IMAGE img[2][2];
	loadimage(&img[0][0], _T("./res/Images/rect_1_0.gif"), 104, 108);
	loadimage(&img[0][1], _T("./res/Images/rect_1_1.gif"), 104, 108);
	loadimage(&img[1][0], _T("./res/Images/rect_2_0.gif"), 104, 108);
	loadimage(&img[1][1], _T("./res/Images/rect_2_1.gif"), 104, 108);
	s_rect.index = 0;
	s_rect.index_2 = 0;

	if ( Welcome() == 1 )
	{
		loadimage( &bg_img, _T("./res/Images/1player.jpg"), 500, 450 );
	...
	{
		loadimage( &bg_img, _T("./res/Images/2player.jpg"), 500, 450 );

		setbkmode( TRANSPARENT );
		outtextxy(  60, 40, _T("player 1"));
		outtextxy( 300, 40, _T("player 2"));
